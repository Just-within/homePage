...
export default function Programs() {
    return (
        <section id="work" className="page-section page" style={{ backgroundColor: '#eee' }}>
            <div className='container' >
                ...
                <Collapse style={{ backgroundColor: '#eee' }}>
                    ...
                    <Panel style={{ borderBottom: '1px solid #DCDCDC', margin: '20px 0', paddingBottom: 20 }} showArrow={false} header={<div style={{ color: '#000', fontSize: 16, fontWeight: 500 }}>Weekly Practice Sittings</div>} key="Weekly Practice Sittings">
                        <p style={{ paddingLeft: 24, color: '#696969' }}>
                            <br />
                    ...
                    <Panel style={{ borderBottom: '1px solid #DCDCDC', margin: '20px 0', paddingBottom: 20 }} showArrow={false} header={<div style={{ color: '#000', fontSize: 16, fontWeight: 500 }}>Study of Chan Master's Teaching</div>} key="Study of Chan Master's Teaching">
                        <p style={{ paddingLeft: 24, color: '#696969' }}>
                            <br />
                            The Study of Chan Master's Teaching program is a focused and contemplative exploration of the rich literary tradition of Chan Teachings. This program offers a unique opportunity for participants to engage in thoughtful inquiry and reflection on the profound teachings of prominent Chan masters.<br />
                            <br />
                            ...
                            <br />
                            Participants will have the opportunity to explore a variety of texts, ranging from classic Chan texts to contemporary interpretations of the teachings. Through thoughtful inquiry and reflection, they will gain a deeper understanding of the principles and practices of Chan Buddhism, and learn how to apply these teachings to their daily lives.<br />
                            <br />
                            This program is suitable for both experienced practitioners and those new to the study of Chan Buddhism. It offers a supportive and engaging environment for participants to explore the teachings of prominent Chan masters, connect with other like-minded individuals, and deepen their understanding of this ancient and profound tradition.<br />
                            <br />
                            Our Introduction to Bible Study program offers a comprehensive exploration of the rich history and teachings of the Bible. Through guided discussions, group study sessions, and individual reflection, participants will gain a deeper understanding of the Bible's teachings and their relevance to modern life.<br />
                            <br />
                            Led by experienced teachers, this program is suitable for both beginners and those with previous experience in Bible study. Topics covered include the history and context of the Bible, the interpretation of scripture, and the application of biblical teachings in daily life.<br />
                            <br />
                            Participants will have the opportunity to engage in meaningful discussions with fellow learners, ask questions, and share their own perspectives on the material. By the end of the program, participants will have gained valuable insights into the Bible's teachings, and developed a deeper appreciation for this ancient text's enduring relevance in today's world.<br />
                        </p>
                    </Panel>
                    <Panel style={{ borderBottom: '1px solid #DCDCDC', margin: '20px 0', paddingBottom: 20 }} showArrow={false} header={<div style={{ color: '#000', fontSize: 16, fontWeight: 500 }}>History of Chan Lineage</div>} key="History of Chan Lineage">
                        <p style={{ paddingLeft: 24, color: '#696969' }}>
                            <br />
                            This program provides a thorough exploration of the historical and cultural context surrounding Chan Buddhism, offering participants a comprehensive overview of its origins, prominent figures and lineages, and the evolution of Chan practice over time. Participants will also learn about the challenges and obstacles that the tradition has faced and how it has adapted and persevered in the face of adversity. This program is designed to provide participants with a deeper understanding of the rich history and cultural significance of Chan Buddhism.
                            Bring reflection to your own practice.
                        </p>
                    </Panel>
                    <Panel style={{ borderBottom: '1px solid #DCDCDC', margin: '20px 0', paddingBottom: 20 }} showArrow={false} header={<div style={{ color: '#000', fontSize: 16, fontWeight: 500 }}>One-to-One Discussion Program</div>} key="One-to-One Discussion Program">
                        <p style={{ paddingLeft: 24, color: '#696969' }}>
                            <br />
